...
<div class="container-fluid"style="padding: 0% 2% 0% 2%;">
  <div class="row" style="background-color:white;">
    ...
    <div class="col-md-6 " style="padding:5%;"><p style="text-align: center;">
      <i class="fa fa-lock" aria-hidden="true" style="width:50px;font-size:50px;border-radius: 100%;"></i></p>
    <h3 style="color:black;text-align: center;">Hello Admin.. Your are Login Here</h3>
<form>
